...
{
    public sealed class PublicBuilding : DataModule<PublicBuilding>
    {
    ...
    public sealed class Growth : DataModule<Growth>
    {
    ...
    public sealed class ResourceData : DataModule<ResourceData>
    {
    ...
    public sealed class ElectricityData : DataModule<ElectricityData>
    {
    ...
    public sealed class PollutionData : DataModule<PollutionData>
    {
        public short pollutionRate;
        public float pollutionRadius;
    }

    public sealed class Tourists : DataModule<Tourists>
    {
    ...
    public sealed class Education : DataModule<Education>
    {
    ...
    public sealed class Medical : DataModule<Medical>
    {
    ...
    public sealed class WaterFacility : DataModule<WaterFacility>
    {
    ...
    public sealed class Entertainment : DataModule<Entertainment>
    {
